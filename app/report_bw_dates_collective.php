...
<html>
<head>
<title>Admin - A/C Statement b/w dates</title>
...
<div class="container">
 <div class="page-content">		    
   ...
   <div class="panel panel-success">  
    ...
    <h3 class="panel-title"><i class="fa fa-square fa-spin fa-fw fa-lg"></i> Report - b/w dates Account Statement
...
<div>
<label style="width:100%; text-decoration: underline; text-align:center; font-size:16pt; font-weight:normal; color:#00F;">Account Statement - Between Dates</label>   
<table class="table table-striped table-bordered" style="margin-top:15px; width:100%;">
    <thead>
    <tr>
    <th colspan="11" class="text-center" style=" text-decoration:underline; color:#C9002F; font-size:11pt; font-weight:normal;">Summary of Totals - From <?php echo date("jS F Y (l)", strtotime($start));?>  to <?php echo date("jS F Y (l)", strtotime($stop));?></th>
    </tr>
	<tr>
        <th style="text-align:center; font-style: italic;"><?php echo date("d/m/Y", strtotime($start));?> - <?php echo date("d/m/Y", strtotime($stop));?></th>
