...
if(isset($_GET['receipt_no']) && $_GET['receipt_no'] !='')
 ...
 <div class="inv-main">    
    ...
    <div style="padding-bottom:10pt; margin-top:-20px; text-align:center"><h3> R E C E I P T</h3> </div>   
     ...
     <table class="table table-bordered" style="margin: 0px;">
      ...
      <tr><th style="font-weight:normal;">
              <span class="pull-left" style="font-weight:bold;font-size:12pt; line-height:10pt;">Escent Diagnostics Pvt. Ltd</span><br/>
              <span class="pull-left" style="font-size:9pt;">Regd. No. MNHCR/NO/096/DC/2012</span><br/>
              <span class="pull-left" style="font-size:9pt;">Purana Rajbari, Nongmeibung, Imphal East, Manipur-795001</span>              
       </th>
   ...
   <table class="table table-bordered" style="margin: 0px;">
      ...
      <tr>
        <th style="font-weight:normal;">
        <span class="pull-left">Reference # &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo 'ED/'.$receipt_no_tbl; ?></span></div>
        </th>
        <th style="font-weight:normal;">
        <span class="pull-right">Date  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo date("d/m/Y,h:i a", strtotime($pr_date)); ?></span></div>
        </th>
       </tr>
       </thead>
       <tbody>
      <tr>
    <td>
    <div class="pull-left padding_right10" style="border-right:dotted 1px; padding-left:5%;">
    <span> REFERRED <br /> BY<br/><br/><br/></span>
    </div>
    <span class="pull-left" style="padding-left:30px;">
	...
	<table class=" table table-bordered width_100" style="margin: 0px;">
      <thead>
      <tr>
...
{   
	...
	?>
     <tbody>
      <tr>
      <td><div style="border-bottom: dotted 1px #333333; line-height:1.75;"><?php echo $sl_no; ?>. &nbsp; &nbsp; 
      <?php echo $test_name; ?></div>
      </td>
      <td><div style="border-bottom: dotted 1px #333333; line-height:1.75;" class="pull-right"> <?php echo $test_price; ?></div></td>
