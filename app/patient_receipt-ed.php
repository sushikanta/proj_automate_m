...
<body>
    ...
    <!--<div style="font-weight:bold; font-size:12pt; padding-bottom:50px; text-align:center"> R E C E I P T </div>-->   
        <div class="header" style="color:#9C6EA4;">           
        <div class="esc-r-header-left">
        <h2 style="line-height:2.52; font-weight:normal;">
        <span class="pull-left text-right padding_left40">Escent Diagnostics</span>
        <span class="text-right pull-right padding_right40"> RECEIPT</span>
        </h2>
