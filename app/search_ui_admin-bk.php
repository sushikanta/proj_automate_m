...
<div class="panel panel-success">
    ...
    Search <span class="panel-subTitle"> ( Admin ) </span>
...
<!----------- ROW 1 reg ------->
<div class="row">
 <form action="reason_ui.php" role="form" method="get" target="_blank" class="form-horizontal inv-form" id="form_reg_eid">
 <div class="form-group" style="margin-top:30px;">
   <div class="form-control-group">
   <label for="reg_eid" class="col-lg-3 control-label"></label>
      <div class="col-lg-6">
   <input type="text" class="form-control" id="reg_eid" name="reg_eid" placeholder="Patient Registration - Edit / Cancel by EiD (e.g. 15559098)" style="line-height:1.8999;" required>
...
<div class="row">
 ...
 <div class="form-group">
   <div class="form-control-group">
   <label for="reg_name" class="col-lg-3 control-label"></label>
      <div class="col-lg-6">
      <input type="text" class="form-control" id="reg_name" placeholder="Patient Registration - Edit / Cancel by Patient name (e.g. Salam Sophia)" name="reg_name"  style="line-height:1.8999;" required>
      <input type="hidden" id="rname_receipt" name="receipt_no">
      <input type="hidden" id="rname_patient" name="patient_id">
      </div>      
...
<div class="row">
 ...
 <div class="form-group" style="margin-top:30px;">
   <div class="form-control-group">
   <label for="disc_eid" class="col-lg-3 control-label"></label>
      <div class="col-lg-6">
   <input type="text" class="form-control" id="disc_eid" name="disc_eid" placeholder="Discount - Add / Edit by EiD (e.g. 15559098)" style="line-height:1.8999;" required>
...
<div class="row">
 ...
 <div class="form-group">
   <div class="form-control-group">
   <label for="disc_name" class="col-lg-3 control-label"></label>
      <div class="col-lg-6">
      <input type="text" class="form-control" id="disc_name" name="disc_name" placeholder="Discount - Add / Edit by Patient name (e.g. Salam Sophia)" style="line-height:1.8999;" required>
...
<div class="row">
 ...
 <div class="form-group">
   <div class="form-control-group">
   <label for="card_name" class="col-lg-3 control-label"></label>
      <div class="col-lg-6">
      <input type="text" class="form-control" id="card_name"  name="card_name" placeholder="Search by Customer name (e.g. Salam Sophia)" style="line-height:1.8999;" required>
		  ...
		  change: function (event, ui){
					if (ui.item == null) 
					  ...
					  { $('#reg_eid').val(ui.item.value);
						...
						$('#reid_patient').val(ui.item.patient_id);
					    return false; } 
					}						
		}).focus(function() {
		  ...
		  change: function (event, ui){
					if (ui.item == null) 
					  ...
					  { $('#reg_name').val(ui.item.value);
						...
						$('#rname_patient').val(ui.item.patient_id);
					    return false; } 
					}						
		}).focus(function() {
                $(this).autocomplete("search");
