...
elseif(isset($_SESSION['user_dept_id']) && $_SESSION['user_dept_id'] == '2' || $_SESSION['user_dept_id'] == '9'|| $_SESSION['user_dept_id'] == '22')
 {
?>
<!DOCTYPE html>
<html>
...
<body>
<?php if($_SESSION['user_dept_id'] == '2'){require_once("right_top_header_admin.php");}elseif($_SESSION['user_dept_id'] == '9'){require_once("right_top_header_hr.php");}elseif($_SESSION['user_dept_id'] == '22'){require_once("right_top_header_mt.php");}?>
<div class="container">
 <div class="page-content">
   <div class="inv-main">
        
<div class="panel panel-success">
      <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-cog fa-spin fa-fw fa-lg"></i> Setting <i class="fa fa-angle-double-right fa-fw"></i> Admin login</h3></div>
