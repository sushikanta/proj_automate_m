...
<!--  <button class="navbar-toggle" data-target=".bs-navbar-collapse" data-toggle="collapse" type="button">-->
  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
    ...
    <a class="navbar-brand" href="#" style="color:#FFF; line-height: 45px; padding-left: 10px"><?php echo @$logo_img; ?>  Front Desk</a>
  <a class="navbar-brand" href="#" style="color:#FFF; line-height: 45px; padding-left: 10px"><!-- <img src="images/logo.png" style="width:60px; height: 47px;" alt="logo"></img>-->  </a>
  </div>
