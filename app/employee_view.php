...
<!--PANEL 1 - OFFICIAL -->
  <div class="panel panel-success">
   <div class="panel-heading light_purple_color">
     <h3 class="panel-title"><i class="fa fa-cubes fa-fw fa-lg"></i> &nbsp;&nbsp;&nbsp;
     Employee <span class="panel-subTitle"> ( Official Info ) </span>
     </h3>
   </div>

<div class="row" style="width:90%; margin-left:5%; margin-top:15px;">
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered display" id="office_tbl">
   <thead align="left">
      <tr>
      <th> # </th>
      <th> Emp No#</th>
  ...
  <tbody>
<?php
$resultO = mysqli_query($con, "SELECT t.ET_id, t.ET_ei_id, t.ET_emp_no, t.ET_join_date, t.ET_salary, t.ET_ctc, t.ET_status, n.designation_name AS position, n1.designation_name AS report_to, department_tbl.department_name FROM emp_tbl t LEFT JOIN designation_tbl n ON n.designation_id = t.ET_desig_id LEFT JOIN designation_tbl n1 ON n1.designation_id = t.ET_report_to LEFT JOIN department_tbl ON department_tbl.department_id = t.ET_dept_id WHERE ET_ei_id = '$ei_id'");
$sl_o=1;
while ($rowO = mysqli_fetch_array($resultO))
{
 	$ET_id = $rowO['ET_id'];
	$ET_emp_no = $rowO['ET_emp_no'];
	$position = $rowO['position'];
	$report_to = $rowO['report_to'];
	$department_name = $rowO['department_name'];

	$ET_salary = $rowO['ET_salary'];
	$ET_ctc = $rowO['ET_ctc'];
	$ET_status = $rowO['ET_status'];
	$join_dateO = date("d/m/Y", strtotime($rowO['ET_join_date']));
	?>
          <tr id="<?php echo $ET_id; ?>">
            <td><?php echo $sl_o; ?></td>
            <td><?php echo $ET_emp_no; ?></td>
            <td><?php echo $position; ?></td>
            <td><?php echo $department_name; ?></td>
            <td><?php echo $report_to; ?></td>
            <td><?php echo $join_dateO; ?></td>
            <td><?php echo $ET_salary; ?></td>
            <td><?php echo $ET_ctc; ?></td>
...
<!------  form  family ---------->
<form id="formOffice" method="post" action="#" title="Add New" style="display:none">

<label id="lblAddError" style="display:none" class="error"></label>
 <div id="processing_messageO" style="display:none" title="Processing">Please wait while processing....</div>

<div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="sl_no">SL # :</label>
  <div class="col-lg-7 padding_gap">
  <input type="text" name="sl_no" class="form-control" value="<?php echo $sl_o;?>" readonly rel="0">
...
<div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="emp_no">Emp No# :</label>
  <div class="col-lg-7 padding_gap">
  <input type="text" name="emp_no" class="form-control capital" placeholder="emp_no" rel="1"/>
  </div></div></div>
  <br/>
 <div class="form-group">
  <div class="form-control-group">
  ...
  <div class="col-lg-7 padding_gap">
   <input type="text" name="position" class="form-control capital" placeholder="emp_no" rel="2"/>
   </div></div></div>
  <br/>
  ...
  <div class="col-lg-7 padding_gap">
  <input type="text" name="department" class="form-control capital" placeholder="Name" rel="3"/>
  </div></div></div>
  <br/>

  <div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="report_to">Report to :</label>
  <div class="col-lg-7 padding_gap">
  <input type="text" class="form-control capital" name="report_to" rel="4" />
  </div></div></div>
  <br/>
  ...
  <label class="col-lg-5 control-label text-right" for="join_date">Joined date :</label>
   <div class="col-lg-7 padding_gap">
  <input type="text" class="form-control" name="join_date" rel="5" />
     </div></div></div>
  <br/>
  <div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="salary">Salary :</label>
   <div class="col-lg-7 padding_gap">
  <input type="text" class="form-control" name="salary" rel="6" />
     </div></div></div>
  <br/>
  <div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="ctc">CTC :</label>
   <div class="col-lg-7 padding_gap">
  <input type="text" class="form-control" name="ctc" rel="7" />
     </div></div></div>
  <br/>
  <div class="form-group">
  <div class="form-control-group">
  <label class="col-lg-5 control-label text-right" for="status">Status :</label>
   <div class="col-lg-7 padding_gap">
  <input type="text" class="form-control" name="status" rel="8" />
     </div></div></div>
  <br/>
  <br/>
</form>
<button id="btnDeleteRowO" style="display:none;">Delete</button> <button id="btnAddNewRowO" style="display:none;">Add</button>
</div>
</div>
...
<!------  form  family ---------->
<form id="formFamily" method="post" action="#" title="Add New" style="display:none;">
...
<!---- form QUALIFICATION ---------->
<form id="formQualf" method="post" action="#" title="Add New" style="display:none;">
...
<!---- form QUALIFICATION ---------->
<form id="formExp" method="post" action="#" title="Add New" style="display:none;">
...
<!---- form letter sent ---------->
<form id="formLetter" method="post" action="#" title="Add New" style="display:none;">
...
<!---- form EXIT ---------->
<form id="formExit" method="post" action="#" title="Add New" style="display:none;">
