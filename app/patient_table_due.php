...
<div class="inv-main">	
  <div class="panel panel-success">  <!----------------------START Patient list-------------->
	<div class="panel-heading" style="color:#0D9707;">
     <h3 class="panel-title"><i class="fa fa-windows fa-spin fa-fw fa-lg"></i> Registration List - <span style="color:#000000; font-style:italic">( Dues )</span>
...
<tbody>
<?php
$result = mysqli_query($con, "SELECT patient_registration.*, patient_info.*, patient_payment.* FROM patient_registration LEFT JOIN patient_payment ON patient_payment.PP_receipt_no = patient_registration.pr_receipt_no LEFT JOIN patient_info ON patient_info.PI_id =  patient_registration.pr_patient_id WHERE patient_payment.PP_bal !=0 ORDER BY patient_registration.pr_date DESC");
$sl_no=1;
