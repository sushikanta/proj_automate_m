...
<body>
<?php require_once("right_top_header_fd.php"); ?>
<?php
if(isset($_POST['submit_pass'])){
	...
	mysqli_query($con, "UPDATE user_table SET user_password = '".$password."' WHERE user_id='$user_id'");
	  ...
	  if($flag){ mysqli_commit($con); header("LOCATION: change_password.php?smsg=7"); } else { mysqli_rollback($con); echo " "; http_response_code(404); }
}
