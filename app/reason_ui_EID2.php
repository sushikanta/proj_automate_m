...
<div class="panel panel-success">
    ...
    Reason <span class="panel-subTitle"> ( Edit / Remove ) </span>
...
<div class="row" style="padding-bottom:250px;">
 <form  action="patient_registration_edit.php" role="form" method="get" class="form-horizontal inv-form" id="form_reason">
 <div class="form-group" style="margin-top:30px;">
  <div class="form-control-group">
  <label for="reason" class="col-lg-3 control-label"></label>
  <div class="col-lg-6">
  <textarea class="form-control" id="reason" placeholder="Registration # <?php echo $receipt_no; ?> : 1. Reason for Edit, Remove,  2. What to do - Add Investigation / Remove Investigation / Edit Source / Edit Source Person / Edit Dr.Referral" name="reason"></textarea>
  <input type="hidden" name="receipt_no" value="<?php echo $receipt_no;?>">
    ...
    <button type="submit" class="btn btn-primary btn-block" style="font-size:16px;" id="go_eid2" name="go_eid2">Submit</button>
    </div>
    </div>
