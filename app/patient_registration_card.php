	...
	for($i=0; $i<$num; $i++)
	 ...
	 // 8) INSERT discount_tbl
	  if($pi_card =='1' && $disc_per > 0){
	   ...
	   $disc_id = date("jmy").getCounter($con, 12);
...
<div class="inv-main">
 ...
 <!----------- ROW 1-------------->
  <div class="form-group">
        ...
        <div class="col-lg-3">
        <input type="text" class="form-control" name="receipt_no" value="<?php echo date("jmy").getCounter($con, 14);?>" readonly>
   ...
   <div class="form-group">
          ...
          <div class="col-lg-3">
           <textarea class="form-control textBox_height" name="patient_history" id="patient_history"
            placeholder="Optional (max.300 characters)" maxlength="300"></textarea>
          </div>
          </div>
   ...
   <div class="form-group">
      ...
      <input type="radio" class="form-control" name="disc_radio" id="disc_yes" value='1' <?php if($PI_card == "1"){echo "checked";} ?> disabled>Yes
          ...
          <input type="text" class="form-control" id="disc_code" name="disc_code" placeholder="Disc Code" value="<?php if($PI_card == "1"){ echo 'D/'.date("jmy").getCounter($con, 12);} ?>" readonly>
          </div>
