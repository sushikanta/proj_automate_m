...
<body>
<?php 	
		if($_SESSION['user_dept_id'] == '2'){include("right_top_header_admin.php");}
    elseif($_SESSION['user_dept_id'] == '3'){include("right_top_header.php");} 
?>
<div class="container">
 <div class="page-content">
  ...
  <div class="panel panel-success">  <!----------------------START price list Information-------------->
	<div class="panel-heading">
        <h3 class="panel-title"><i class="fa  fa-info-circle fa-spin fa-fw fa-lg"></i> PIN Code - Manipur
     	<a class="text-right pull-right navbar-link" href="FYI_referrals.php"><i class="fa fa-arrow-circle-right fa-fw fa-lg"></i></a>
     	</h3>
     </div>
