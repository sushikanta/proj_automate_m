...
<tbody>
<?php
$result = mysqli_query($con, "SELECT `A_id`, `A_book`, `A_action`, `A_p_id`, `A_remark`, `A_user`, `A_date` FROM `audit_tbl` WHERE A_p_id='$receipt_no' AND A_book='26' ORDER BY A_date ASC");
$sl_no=1;
...
?>
 <tr>
      ...
      <td><?php echo showFull_login($con, $A_user); ?></td>     
