...
<div class="container">
 <div class="page-content">
  ...
  <div class="panel-heading light_purple_color">
     <h3 class="panel-title"><i class="fa fa-cubes fa-fw fa-lg"></i> FD - <span class="panel-subTitle">  Dues Report</span>
...
<thead align="left">
  ...
  Dues Report ( <?php if($type =='22'){ echo showSourceName($con, $pass_source_id).'s, on'; } else{ echo 'ALL, on';} ?> <?php echo date("d/m/Y h:i a", time());?> )
  </th>
  </tr>
...
if($type =='11'){
$result = mysqli_query($con, "SELECT y.PP_total, y.PP_tax, y.PP_disc, y.PP_net, y.PP_paid, y.PP_bal, y.PP_date, r.pr_dr_prescription, r.pr_receipt_no, r.pr_source_id, r.pr_referred_id, r.pr_date, p.PI_name FROM patient_registration r LEFT JOIN patient_payment y ON r.pr_receipt_no = y.PP_receipt_no LEFT JOIN patient_info p ON p.PI_id = r.pr_patient_id WHERE y.PP_bal !=0 ORDER BY r.pr_source_id ASC");
}
