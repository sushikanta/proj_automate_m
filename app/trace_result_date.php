...
<tbody>
<?php
$result = mysqli_query($con, "SELECT `A_id`, `A_book`, `A_action`, `A_p_id`, `A_remark`, `A_user`, `A_date` FROM `audit_tbl` WHERE A_date BETWEEN '".$start."' AND '".$stop."' ORDER BY A_date ASC");
$sl_no=1;
