...
if (!isset($_SESSION['app_settings']) && @$con) {
    getSettings($con);
}
    ...
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"
               style="color:#FFF; line-height: 45px; padding-left: 10px"><?php echo @$logo_img; ?> <?php echo $app_title; ?>:
                Login</a>
        </div>
    </div>
</header>
        ...
        <div class="col-lg-5 col-lg-offset-4 login-block">
            ...
            <?php if (isset($_GET['errmsg']) && $_GET['errmsg'] !== '') {
                ...
                <div class="alert alert-danger alert-error">
                    ...
                    <strong><i class="fa fa-times-circle fa fa-lg fa-fw"></i>
                    </strong> <?php echo error_message($con, $_GET['errmsg']); ?>
                </div>
            <?php } ?>
            <!----------------------------- End ERROR/SUCCESS MSG------------------------------------>

            <?php if (@$con && isset($_GET['smsg']) && $_GET['smsg'] != '') { ?>
                <div class="alert alert-success alert-error">
                    <a href="#" class="close" data-dismiss="alert">&times;</a>
                    <strong><i class="fa fa-check-circle fa-lg fa-fw"></i>
                    </strong> <?php echo success_message($con, $_GET['smsg']); ?>
                </div>
            <?php } ?>

            <div class=""><h4 align="center" style="color:#3366ff;">Login</h4>
                <hr/>
            </div>
