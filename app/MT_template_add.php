...
<table cellpadding="0" cellspacing="0" border="0" class="table table-hover" id="test_tbl">
  <thead align="left">
      <tr><th colspan="<?php echo $t_column+1; ?>" class="text-center"><?php echo $template; ?></th></tr>
  </thead>
  <tbody> 
 <?php  
	 ...
	 <tr>	   
		...
		?>
		 <td>
		 <textarea class="form-control" name="input_name[<?php echo $counter_row;?>][<?php echo $counter_column;?>]" <?php if($counter_column ==2){echo 'disabled';} ?>  placeholder="1st Row = Heading, 2nd Column = Result, Others = Fixed inputs" maxlength = "300" style="width:100%;"><?php echo showData_rowColumn($con, $tpn_id, $counter_row, $counter_column); ?></textarea>
         </td>
	  <?php	} 
	  }
 ?>
        ...
        <input type="hidden" name="total_column" id="total_column" value="<?php echo $t_column; ?>">
        <input type="hidden" name="total_row" id="total_row" value="<?php echo $t_row; ?>">
</tbody>
</table>
