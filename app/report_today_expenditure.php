...
<!DOCTYPE html>
<html>
<title>Admin - A/C Expenditure</title>
...
<div class="container">
 <div class="page-content">		    
    ...
    <h3 class="panel-title"><i class="fa fa-square fa-spin fa-fw fa-lg"></i> Report - One day Expenditure
...
<div>
<label style="width:100%; text-decoration: underline; text-align:center; font-size:14pt; font-weight:normal; color:#00F;"> Account Statement - One day Expenditure (<?php echo date("d/m/Y", strtotime($today_date));?>)</label>
<table class="table table-striped table-bordered font-table" style=" margin-top:15px; width:100%;" id="example">
<thead align="left">
<tr>
...
?>
<tr>            
    <td colspan="4" class="price-amount" style="text-align:right;">
