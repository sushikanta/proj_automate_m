...
resetCounter($con, 1, 'dd');	// Patient Info
...
/****************************
 ...
 33   Deleted
		 ******************************/
		 ...
		 $remark = 'Patient Info : CusID - '.$patient_id.' ( Name : '.$patient_name.')';
		 mysqli_query($con, "INSERT INTO audit_tbl(A_id, A_book, A_action, A_p_id, A_remark, A_user, A_date) VALUES ('$A_id', '29', '22', '$patient_id', '".$remark."', '$user_id', NOW())");
	...
	if($flag){
			mysqli_commit($con);
			header("location: patient_registration_card.php?patient_id=$patient_id");
			} else {
			mysqli_rollback($con);
...
<div class="inv-main" id="div_main">
  ...
  <div class="panel-heading light_purple_color">
    ...
    Add <span class="panel-subTitle">( Patient / Customer Info ) </span>
  ...
  <div class="panel-body">
   ...
   <!----------------  ROW 1  ------------>
      <div class="form-group" style="padding-top:35px;">
        ...
        <div class="col-lg-3">
        <input type="text" class="form-control" id="patient_id" name="patient_id" value="<?php $patient_id = date("jmy").getCounter($con, 1);echo $patient_id;?>" readonly>
        </div>
        </div>

        <div class="form-control-group">
        <label for="state" class="col-lg-2 control-label"> DATE </label>
     ...
     <div class="form-control-group">
      ...
      <div class="col-lg-3">
          <label for="optionsRadios1" class=" control-label radio-inline col-lg-2" style="margin-right:20px;">
            <input type="radio" class="form-control" name="patient_sex" id="optionsRadios1" value=1>MALE</label>
          <label for="optionsRadios2" class=" control-label radio-inline col-lg-2">
            <input type="radio" class=" form-control" name="patient_sex" id="optionsRadios2" value=2>FEMALE</label>
      </div>
     </div>
